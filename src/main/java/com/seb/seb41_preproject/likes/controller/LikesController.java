...
public class LikesController {
    ...
    public LikesController(LikesService likesService, LikesMapper likesMapper, LikesRepository likesRepository) {
    ...
    public ResponseEntity PostLikes(@RequestBody LikesPostDto likesPostDto, @PathVariable("post_id") Long postId, @AuthenticationPrincipal String userEmail) {
